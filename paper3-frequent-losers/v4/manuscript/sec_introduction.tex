...
\noindent Our primary contribution is to show that FL presence is a % CO-AUTHOR EDIT: rewritten contributions framing for IJIO/JLEO
...
\emph{First}, we show that FL presence is a reliable empirical marker % CO-AUTHOR EDIT: "establish" → "show"
...
\emph{Second}, we provide evidence consistent with the causal mechanism % CO-AUTHOR EDIT: softened from "causal evidence"
