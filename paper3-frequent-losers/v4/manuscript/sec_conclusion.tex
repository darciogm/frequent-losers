...
The evidence strongly supports H1: FL presence is a reliable empirical % CO-AUTHOR EDIT: "establish" → "strongly supports"; softened throughout
...
stronger within-tender correlation than non-FL pairs (bootstrap
$p < 0.001$), though the magnitude comparison should be interpreted
with caution given the tender FE reversal discussed in
Section~\ref{sec:results_bajari}. The evidence is consistent with Regime~1
(complementary cover bidding) where FL firms submit bids from a wide
distribution above the winning price. While we cannot rule out all alternative explanations, the convergence % CO-AUTHOR EDIT: "conclusively prove" → "rule out"; softened
...
bid-level screens (Bajari--Ye, variance tests) to assess coordination % CO-AUTHOR EDIT: "confirm" → "assess"
...
For competition authorities, the FL screen can be integrated with % CO-AUTHOR EDIT: added enforcement integration sentence
...
\paragraph{Broader implications.} % CO-AUTHOR EDIT: added IO/L&E identity paragraph
