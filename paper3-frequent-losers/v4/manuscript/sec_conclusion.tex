...
procurement anomalies. FL-present tenders exhibit 4--9\% higher
...
vs.\ 0.064 baseline). These findings strongly support H1: the FL
...
bid-level screens (Bajari--Ye, variance tests) to confirm coordination
