...
0.404 ($p < 0.01$), consistent with the OLS finding: instrumented FL presence % CO-AUTHOR EDIT: "confirming" → "consistent with"
...
of existing competition. This rules out competitive crowding-out and is % CO-AUTHOR EDIT: added H2 connective sentence
...
undercut it. This calibration pattern is consistent with cover bidders % CO-AUTHOR EDIT: added H2 connective sentence
...
effect attributed to FL presence. The reverse-causality effect is two % CO-AUTHOR EDIT: added H2 connective sentence
...
\subsection{Summary} % CO-AUTHOR EDIT: added bridge paragraph linking mechanisms to H2
