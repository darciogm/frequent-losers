...
detects anomalies beyond known cartels. Evaluated as a detection tool,
the FL screen achieves an AUC of 0.94 (Section~\ref{sec:results_detection}),
substantially outperforming bid-level screens based on price dispersion
alone (AUC~$= 0.79$; DeLong $p < 0.001$). % CO-AUTHOR EDIT: FORWARD REFERENCE AUC [T3.2]
