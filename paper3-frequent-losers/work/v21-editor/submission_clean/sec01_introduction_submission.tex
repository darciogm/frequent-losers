...
flags and evidentiary conclusions \citep{chassang2022robust}. We
formalize this stage as a decision-theoretic triage problem
(\S\ref{sec:triage-model}) whose central institutional property
is a \emph{separation of attention from liability}: the optimal
cheap-signal index orders where to investigate while remaining,
by construction, uninformative about who is liable.
