...
participation history: the largest cell (low-HHI, low-pairs) drops
from an unmatched effect of $\valMatchedHetLLUnmatched$
($p=\valMatchedHetLLUnmatchedP$) to $\valMatchedHetLLMatched$
($p=\valMatchedHetLLMatchedP$) once volume is matched away. What
