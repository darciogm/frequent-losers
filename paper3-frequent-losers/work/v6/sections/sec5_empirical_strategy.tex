...
% REVISION-V6: RDD removed — BEC records unit prices, not total contract
% values. The R$80K modality threshold applies to total procurement value,
% which is not directly observable in the data. A valid RDD would require
% total contract value, which future work with complementary administrative
% data could provide.
