...
authority convictions yields an area under the ROC curve of 0.94, with
the data-driven optimal threshold nearly identical to the statistical
rule used for FL classification. We derive the welfare-maximizing
detection threshold as a function of enforcement capacity, providing a
practical screening tool for competition authorities.
\end{abstract}
