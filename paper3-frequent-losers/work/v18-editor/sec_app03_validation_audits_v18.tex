...
\texttt{pROC::ci} on a binary outcome). The permutation does
not make cobidder status causal or legal proof. It answers the
narrower exposure concern: the frequent-loser concentration
