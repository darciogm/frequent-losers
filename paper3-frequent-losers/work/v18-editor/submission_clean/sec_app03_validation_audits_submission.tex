...
computed via the DeLong method, which is the default for
\texttt{pROC::ci} on a binary outcome). The permutation answers
...
to random classification. That pattern is informative: the
