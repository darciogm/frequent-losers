...
opportunity sets for meeting CADE defendants. \ref{app:validation_audits_submission}
reports the exact
...
anchored AUC is 0.92 in-sample and 0.79--0.85 in the strict
prospective holdout, alongside an AUC near 0.5 against direct
CADE defendants---the asymmetry is the screen's anti-overclaiming
property, not a failure to detect. Joint scoring with award and
bid features is the full-observability upper bound; sequential
gatekeeping is the architecture relevant for agencies that must
decide where to spend costly bid recovery. The price-side scope
of loser-side concentration in this panel is on the order of
R\$40--211 million per year (1.3--2.4\% of the R\$12 billion
annual procurement volume), which is the institutional magnitude
