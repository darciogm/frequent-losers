...
explicitly so that the empirical comparison is read as an
evidence-allocation design rather than as a claim that thin
records substitute for full bid files.
...
evaluation because they describe how bids are placed inside tenders.
...
\begin{quote}
\textbf{Algorithm G.1: Award-Layer Gatekeeping}
\begin{enumerate}
