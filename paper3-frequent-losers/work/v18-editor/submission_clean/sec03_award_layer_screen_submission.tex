...
limited information. We follow the threat-driven screen-design
tradition of \citet{harrington2008detecting} and the
bid-distribution screen evaluation in
\citet{imhof2018screening}: a screen is informative only to the
extent that it survives the alternative explanations a thoughtful
referee would offer. Table~\ref{tab:testable_implications_submission}
