...
ranking. Cover bidders are repeatedly deployed to provide losing
...
The framework does not imply that all zero-win firms are cover
bidders, that frequent-loser status is legal membership, or that
any specific bid is a cover bid. It supplies only the ranking
logic for triage.
