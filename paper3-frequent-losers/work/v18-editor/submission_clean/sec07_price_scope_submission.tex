...
central enforcement-design result. The main claim does not
require a causal price effect. The screen is designed to allocate
costly proof-producing attention, not to estimate cartel markups,
damages, or welfare losses. Price evidence is still useful, but
only in a narrower role: it asks whether prioritized
environments look economically non-neutral and where that
interpretation must stop. Overcharge measurement has its own
evidentiary tradition
...
evidence collection, not a stand-alone measure of price injury.
