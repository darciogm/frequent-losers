...
complementary lines of evidence support the framework: a
$\valOLSGeneralPBU$ within-item, within-PBU conditional price premium, a $\valPBUgradientRatio\!\!\times$
...
FL-winner pair counts $\valDyadicRatio\!\!\times$ above the permutation
...
of $\valWelfareDenom$ in BEC spending) under removal of the minimum-bidder rule.
