...
We document six independent lines of empirical evidence consistent
with the framework: (i) a $6\%$ within-item conditional price premium
...
ratio that is independent of our construct; (v) repeated FL-winner
pairs occur $\valDyadicRatio\!\!\times$ above stratified-permutation
...
\item Six independent lines of evidence: price premium, oversight gradient, structural regime, Bayesian latent-class agreement, dyadic permutation, and CADE within-stratum AUC.
...
\item Bayesian latent-class agreement: $\Pr(\text{cover}\mid\text{FL})=\valLCAprobCoverFL$ vs.\ $\valLCAprobCoverNonFL$ for non-FL ($\valLCAratio\!\!\times$ ratio)—independent of our construct.
\item Counterfactual welfare bounds: \valWelfareCrossfit--\valWelfareIV\ ($\sim$$\valCounterDeadHigh$ of BEC spending), illustrative not causal.
