...
Mechanically multiplying the price coefficients by FL-present spending
gives R\$734M (OLS) and R\$400M (cross-fit) over the decade. Both
assume full causality, which is not established; they are rough
benchmarks, not policy estimates
...
model predicts ($\partial m^*/\partial \theta_k < 0$): smaller PBUs
