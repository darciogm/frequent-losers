...
($\hat{\sigma}_c / \hat{\sigma}_g = 0.72$). The most informative heterogeneity result comes from convite
tenders where the minimum-bidder rule does not bind: the FL
coefficient there is 7.6\%, larger than in tenders where the rule
forces participation. This voluntary-deployment premium is more
naturally read through a cover-bidding lens, though selection within
the non-binding subsample cannot be excluded
