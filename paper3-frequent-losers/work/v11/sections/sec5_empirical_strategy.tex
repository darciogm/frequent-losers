...
(Section~\ref{sec:detection_validation}). Finally, we assemble
mechanism evidence for cover bidding (H2) from structural likelihood
...
(Section~\ref{sec:empirical_network}). The mechanism evidence is
suggestive; no single test clinches a causal channel.
