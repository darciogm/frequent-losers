...
$b^*$, producing \emph{lower} dispersion---the signature of
coordinated calibration near a focal point. BIC selects between
...
Table~\ref{tab:predictions} maps the framework's predictions to
empirical tests.

\begin{table}[htbp]
\centering
\caption{Predictions from the cover-bidding framework}
