...
cartelists at 3.5$\times$ the baseline rate. Independent diagnostics
--- Bajari--Ye tests, invitation heterogeneity, bid-level
patterns --- produce results coherent with cover bidding.
