...
| `\valFL` | `2{,}537` | `data/processed/FREQ_PARTICIP_rebuilt.parquet ` | ` data/processed/firm_loss_stats.parquet ` | ` data/processed/cade_*.csv` |
...
| `\valThreshold` | `14` | `data/processed/FREQ_PARTICIP_rebuilt.parquet ` | ` data/processed/firm_loss_stats.parquet ` | ` data/processed/cade_*.csv` |
...
| `\valAUCFLfirm` | `0.911` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
| `\valAUCFLfirmCIlo` | `0.898` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
| `\valAUCFLfirmCIhi` | `0.925` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
| `\valAUCFLfirmCI` | `[0.898,\ 0.925]` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
| `\valAUClogtc` | `0.939` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
| `\valAUClogtcCIlo` | `0.932` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
| `\valAUClogtcCIhi` | `0.946` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
| `\valAUClogtcCI` | `[0.932,\ 0.946]` | `scripts/34_horse_race_fl_continuous.R ` | ` output/horse_race/horse_race_summary.csv` | `—` |
...
| `\valAUCImhofFull` | `0.888` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
| `\valAUCImhofFullCI` | `[0.865,\ 0.911]` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
...
| `\valAUCImhofPlusFL` | `0.955` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
| `\valAUCImhofPlusFLCI` | `[0.943,\ 0.967]` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
| `\valAUCImhofPlusTC` | `0.962` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
| `\valAUCImhofPlusTCCI` | `[0.954,\ 0.969]` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
| `\valAUCFLalone` | `0.902` | `v13 legacy verified constants (final coverage pass)` | `—` | `—` |
| `\valAUCFLaloneCI` | `[0.884,\ 0.923]` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
| `\valAUCTCalone` | `0.884` | `v13 legacy verified constants (final coverage pass)` | `—` | `—` |
| `\valAUCTCaloneCI` | `[0.860,\ 0.908]` | `scripts/31_imhof_full_pipeline.R ` | ` output/imhof_full/imhof_full_results.csv` | `—` |
...
| `\valCobidShareFL` | `7.1\%` | `v13 legacy verified constants (no CSV source --manual back-of-envelope)` | `—` | `—` |
| `\valFLrateAL` | `16\%` | `v13 legacy verified constants (no CSV source --manual back-of-envelope)` | `—` | `—` |
