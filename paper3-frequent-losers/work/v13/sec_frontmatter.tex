...
\title{Detecting Bid-Rigging Cartels Without Bid Microdata: A Frequent-Losers Screen\texorpdfstring{\footnote{This version: April 2026.}}{}}
...
abnormally many tenders, a pattern consistent with regulatory
cover bidding under Brazilian procurement law's minimum-bidder
rule. Applied to 4.5 million tender-items from Brazilian public
...
with firms subsequently convicted by the competition authority
(CADE), most cases adjudicated after the sample window---so the
external check is partly prospective. The price gap is a conditional association,
