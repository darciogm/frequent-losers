...
Cinelli--Hazlett yields $RV_{q=1} = \valRVqOne$: an unobserved
confounder would need to explain at least $\valRVqOne$ of residual
...
Only $\valPctTenRef$ of firms classified as FL on 2009--2013 data reappear
as FL on 2014--2019 data ($111$ of $\valBoundaryFLone$). FL is therefore
...
clear adjudication; the cross-sector AUC stability of $\valAUCCrossSectorMean$
...
uniformly $\geq 0.90$ with mean $\valAUCCrossSectorMean$ (SD $\valAUCCrossSectorSD$). The
