...
\smallskip
{\footnotesize\textit{Notes:} The strict-train threshold estimated only on $2009$--$2016$ is $7.0$, far below the full-sample paper-rule threshold of $13.5$. The revised paper attaches theory to the continuous loser-side concentration object and treats the binary FL rule as an administrative compression rather than a theoretically unique boundary.\par}
\end{table}
