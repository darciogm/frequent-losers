...
Sections~\ref{sec:supporting_setup}--\ref{sec:empirical_network}
...
(23.2 million non-FL losing bids and 189{,}381 FL losing bids);
...
tenders (mean pairwise product, bootstrap with 1{,}000 iterations,
