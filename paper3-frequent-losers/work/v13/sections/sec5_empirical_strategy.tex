...
Convite (Lei 8.666/93 Art.\ 22) requires three valid proposals;
pregão (Lei 10.520/2002) has no analogous rule. Comparing
...
\item \textbf{Statutory value threshold}. Lei 8.666/93 Art.\ 23
caps convite procurement at R\$80{,}000 (R\$176{,}000 after
Decreto 9.412/2018); above the cap, only pregão is permitted.
...
McCrary-style density tests around the R\$80{,}000 cap find no
evidence of bunching (left/right density ratio $0.94$,
log-density discontinuity $-0.063$;
Table~\ref{tab:mccrary}); the convite share drops 9.8
percentage points across the cap (69\% below, 59\% above),
...
cover bidders---via the McCrary density check at the R\$80{,}000
...
explain at least 17.5\% of residual variation in both FL
...
entry with respect to lagged prices is $0.0021$ (SE $0.0008$);
