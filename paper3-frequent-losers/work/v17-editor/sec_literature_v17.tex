...
The paper sits at the conjunction of four literatures, each
working at a different data layer. Bid-coordination tests read
collusion off bid-function exchangeability conditional on a
researcher-supplied partition. Bid-distribution screens read
collusion off within-tender moments of submitted bids.
Cover-bidding studies identify the loser side of collusive
arrangements retrospectively, after a cartel has been
adjudicated. And enforcement-design work asks how detection
regimes should be sequenced under imperfect monitoring. We
position the screen by the informational layer it operates on.
...
low marginal cost. Two implications travel to our setting. First,
when bid-level observability is absent at the operational layer,
the appropriate screening object is whatever statistic the
...
is the empirical implication of this sequencing logic. A growing
empirical literature documents how procurement institutions
shape what enforcement can observe
\citep{coviello2017tenure,decarolis2017corruption,decarolis2020rules};
