...
Section~\ref{sec:results_bajari}. The structural estimation selects % R1-FIX: Regime 2, consistent with BIC (ΔBIC = −91,473)
Regime~2 (coordinated cover bidding), in which cover bids cluster
near a focal point above the winning price with lower dispersion
than genuine bids ($\hat{\sigma}_c / \hat{\sigma}_g = 0.72$).
