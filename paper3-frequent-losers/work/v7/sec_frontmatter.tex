...
participate abnormally often). The structural estimates confirm coordinated cover % V7: abstract — honest structural framing
bidding (cover-bid dispersion 28\% below genuine-bid dispersion) and
an associated price markup of 6.4\% in tenders with FL presence.
