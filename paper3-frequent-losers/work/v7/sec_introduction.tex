...
purchasing-unit fixed effects (preferred specification: 6.6\%).
...
Section~\ref{sec:structural} develops a framework for cover-bidder % R1-FIX: removed duplicate sec:literature reference
