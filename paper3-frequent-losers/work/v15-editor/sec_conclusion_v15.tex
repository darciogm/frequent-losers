...
data envelopes (AUC $0.903$ vs $0.888$ on the same
cartel-adjacency target) and non-redundant signal when both
envelopes are available (combined AUC $0.962$, +$0.096$ over
either alone). Under incomplete observability the deployable
