...
design-by-design performance table are in Online Supplement~\ref{supp:bid_cost}. The
...
and per-feature missingness tables are in Online Supplement~\ref{supp:bid_cost}.
...
spec-by-spec audit and fold compositions are in Online Supplement~\ref{supp:bid_cost}.
...
are in Online Supplement~\ref{supp:bid_cost} (bid-layer performance table).
