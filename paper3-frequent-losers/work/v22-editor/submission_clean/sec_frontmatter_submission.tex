...
participation---and validate it against a reproducibly
constructed, adjudication-anchored cobidder label that never uses
the screen itself. The decomposition is deliberately deflationary:
