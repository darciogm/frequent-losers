...
| 4 | Label funnel + 193 vs 210 reconciliation | **critical** | sec04 §4.1; sec_app02 | NEW `79_label_funnel.R`; `99_make_paper_values.R:1320-1322` | `output/label_funnel/funnel.csv`; Table A | Table A funnel; retire/replace 210/108/30 | ⛔ | **210/108/30 unsourced literals; ~19-20≠30 reconstructable; no case_id on cobidders.** CP-1. See blockers Q7 |
