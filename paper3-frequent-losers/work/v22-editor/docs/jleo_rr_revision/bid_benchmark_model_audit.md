...
_Generated 2026-06-04 16:23:54 by `09_bid_benchmark_validation.R` (seed 20260603). Numbers are from this run; never invented._
...
- **Candidate pool**: always-losers with COMPLETE Imhof feature set, direct CADE defendants excluded. N=16,731, positives=651.
...
4. **What is the candidate pool?** Always-losers with complete Imhof features, defendants excluded (N=16,731, 651 positives).
...
8. **Default validation?** 5-fold RANDOM CV. Reproduces bid AUC=0.717, combined AUC=0.756 (vs script-31 0.888/0.962).
...
10. **Does case-grouped CV change it?** Yes — Design E pooled bid AUC=0.626, combined AUC=0.689.
...
12. **What happens excluding them?** Design F bid AUC=0.713 (vs 0.717 pooled); contamination delta=-0.004.
