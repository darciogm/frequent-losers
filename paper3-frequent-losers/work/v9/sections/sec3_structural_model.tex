...
Together, these enable \emph{regime identification}---determining % CO-AUTHOR EDIT [TASK-5]: highlight model's primary empirical contribution
whether observed FL bids follow the complementary (Regime~1) or
