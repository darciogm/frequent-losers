...
Multiple diagnostics provide suggestive evidence for cover bidding as
the underlying mechanism (H2): the FL--price effect concentrates in
competitive markets (Proposition~\ref{prop:market_selection}),
Bajari--Ye diagnostics indicate exchangeability and
conditional-independence violations, and structural estimation favors
Regime~2 ($\hat{\sigma}_c / \hat{\sigma}_g = 0.72$), indicating
coordinated but imperfectly controlled cover-bid placement. No single
test is conclusive, but the consistency across independent strategies
supports the cover-bidding interpretation. Removing the convite
