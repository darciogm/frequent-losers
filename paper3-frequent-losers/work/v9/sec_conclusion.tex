\section{Conclusion} % V8: compressed
...
3.6--6.6\% higher prices, FL firms co-participate with CADE-convicted
...
exchangeability and conditional independence, and structural estimation
selects Regime~2 ($\hat{\sigma}_c / \hat{\sigma}_g = 0.72$). Removing
the convite minimum-bidder rule would save R\$74--211M, and the
