...
when evidence-grade records are costly to open. On São Paulo's BEC
...
decision is a budget-dependent cost–recall frontier, the image of a
cost–benefit optimum with no fixed cutoff to defend. Here the raw
screen's reach is mostly exposure rather than conduct, and strict
prospective ranking fails outside incumbent pools. On a second
