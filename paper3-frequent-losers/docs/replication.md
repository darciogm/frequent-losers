...
!!! note "The submission is now a three-document package"
    ...
    |----------|--------|--------|-------|
    | **Paper** | `paper_submission_clean.tex` | ~45 pp | Body: the over-crediting characterization (lead contribution), the modest enforcer stopping rule, the BEC audit, the federal portability leg |
