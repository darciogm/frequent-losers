...
| [H5](cobidder-profile-distinct.md) | FL cobidders are economically distinct from other FLs. | Descriptive: Cohen's d 0.3–1.0 across 7 dimensions + bid-level median-gap d = −0.28. Negative: matched quadrant heterogeneity attenuates 26–35%; first-time-FL channel demoted (p = 0.31 matched). | [AN-008](../analyses/an-008-pbu-characterization.md), [AN-009](../analyses/an-009-network-hhi.md), [AN-024](../analyses/an-024-unified-mechanism.md), [AN-028](../analyses/an-028-exposure-stratum-balance.md), [AN-031](../analyses/an-031-bid-level-behavioral-profile.md), [AN-032](../analyses/an-032-matched-heterogeneity-audit.md), [AN-021](../analyses/an-021-first-time-fl-matching.md) | **Partial (strongly supported)** |
