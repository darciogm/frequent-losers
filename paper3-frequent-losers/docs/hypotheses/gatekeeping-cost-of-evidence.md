...
> Backed by §6.3–§6.4 of the [manuscript](../paper.md) ("Gatekeeping the
> Forensic Stage", "Timing the Gatekeeper"). AN pages to follow.
...
|---|---|---|
| [AN-012](../analyses/an-012-operational-metrics.md) (in-sample precision@k) | Direct | pending |
| [AN-013](../analyses/an-013-precision-at-k-audit.md) (temporal holdout) | Direct | pending |
| [AN-014](../analyses/an-014-leakage-audit-d3.md) (leakage audit) | Supports | pending |
