...
for tail inference. All results come from a single electronic procurement platform
(BEC/S\~ao Paulo). The dispersion paradox depends on Regime~2
(coordinated cover bidding), which in turn requires real-time
information exchange---a feature of electronic auctions (preg\~ao).
In jurisdictions where sealed-bid formats dominate, Regime~1 may
