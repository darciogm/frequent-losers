...
\end{equation}
This is a consistency check: under the model, the $n$-conditional
and unconditional coefficients should be similar, because the model
predicts that differential genuine competition does not drive the
FL--price association. The structural parameters
$(\hat{\epsilon}, \hat{\sigma}_c)$ characterize the cover-bid
\emph{mechanism}; the price association is a separate reduced-form
object that the structure helps interpret but does not causally
identify.
...
bid distributions. The regime selection (BIC) selects which distributional family
fits FL-labeled bids better in this setting, not which regime
