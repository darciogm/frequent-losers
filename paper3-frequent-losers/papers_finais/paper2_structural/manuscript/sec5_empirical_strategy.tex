...
The dispersion paradox is an equilibrium prediction---testing it
requires an estimation strategy that separates distributional
parameters (how cover bids are calibrated) from behavioral parameters
(how many cover bidders the cartel deploys). The estimation has four
