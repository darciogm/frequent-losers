...
confirm in Section~\ref{sec:spec_tests}.
...
(complementary cover bidding). Our structural estimation shows
Regime~2 (coordinated) dominates, explaining the detection gap
between participation-based and variance-based screens.
