...
\begin{description}
  \item[A1 (Surplus structure).] $\pi(b^*, m, n) = b^* - c_{j^*}$
    with $\partial \pi / \partial m \geq 0$: additional cover bidders
    help sustain $b^*$ by creating the appearance of competition.
