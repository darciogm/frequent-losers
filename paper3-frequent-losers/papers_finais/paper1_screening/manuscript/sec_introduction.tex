...
The rule outperforms both a random forest and a structural
classifier on the same ground truth (Section~\ref{sec:classification_robustness}):
...
Regime~2, with cover-bid dispersion 28\% below genuine bids.
...
competition-authority convictions, outperforming both a random forest
and a structural classifier on the same ground truth. The screen is
