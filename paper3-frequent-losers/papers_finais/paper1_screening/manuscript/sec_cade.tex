...
(3.5$\times$, stratified by participation quartile) indicates that the
excess is real, not mechanical. For enforcement purposes, this is the
relevant target: a triage rule that flags environments warranting
closer scrutiny, not a tool that adjudicates firm-level liability.
