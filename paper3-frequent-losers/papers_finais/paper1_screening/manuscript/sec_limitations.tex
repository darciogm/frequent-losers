...
FL--price association or proof of the cover-bidding mechanism.
The screen is best interpreted as an investigative prioritization
device---a triage tool that flags suspicious environments for closer
scrutiny---rather than evidence sufficient to infer firm-level
liability or sanction cartel membership. The main limitations are
as follows.
...
bid-level forensics and periodic threshold recalibration.
...
the case for deploying the screen; they do not constitute proof.
