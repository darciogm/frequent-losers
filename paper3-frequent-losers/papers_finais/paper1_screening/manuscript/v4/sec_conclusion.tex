...
The hardest cartels to detect are the ones that look competitive.
When cover bidders coordinate tightly, the tenders they contaminate
produce textbook-looking bid distributions---low variance, smooth
spacing---while prices quietly climb. The frequent-loser screen
bypasses this trap by ignoring what firms bid and focusing on a
simpler signal: who keeps showing up to lose. In S\~ao Paulo's
procurement, this signal flags environments with 3.6--7.7\% higher
conditional prices, achieves AUC~$= 0.94$ against known cartels
(surviving exact count matching at $2.2\times$), and requires nothing
...
For a triage tool, these are features, not defects. An enforcement
