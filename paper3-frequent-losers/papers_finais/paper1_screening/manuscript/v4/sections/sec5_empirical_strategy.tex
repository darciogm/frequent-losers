...
is coherent with coordinated cover bidding. These support the
...
threshold. Classical binary measurement error attenuates the OLS
coefficient toward zero. We use a leave-one-out FL supply
...
is coherent with OLS understating the association; our primary range is
