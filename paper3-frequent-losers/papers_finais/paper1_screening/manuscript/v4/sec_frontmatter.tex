...
contributes substantially to the unconditional figure),
complements bid-level tools (correlation 0.06), and flags
environments with 3.6--7.7\% higher conditional prices. The price association is
