...
\item \textbf{Institutional design implications.} The framework suggests, and the data are consistent with the view, that the minimum-bidder rule in sealed-bid procurement (convite) creates a direct incentive for cover bidding. This has implications for procurement regulation, including Brazil's recent Lei 14.133/2021 reform.
\end{enumerate}
