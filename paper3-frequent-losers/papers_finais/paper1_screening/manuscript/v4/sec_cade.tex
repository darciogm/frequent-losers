...
designed to exploit. The permutation test (3.5$\times$, stratified
by participation quartile) indicates that the excess is not
...
association is not driven by tenders CADE has already flagged. This is the screen's practical value for enforcement: it flags
environments beyond the reach of existing enforcement records,
directing scarce investigative resources toward markets that would
otherwise go unscrutinized.
