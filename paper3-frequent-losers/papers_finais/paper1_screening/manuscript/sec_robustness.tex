...
reading but are themselves informative: PBUs receiving FL entry
\emph{already had higher prices}---the market-selection pattern
predicted by the model. The paper relies on within-item conditional
comparisons precisely because strategic selection into markets is a
pattern the framework predicts; conditioning on item absorbs this
selection.
...
The FL price association varies steeply with PBU size: 0.214 in the
