...
preg\~ao--convite gap---and is consistent with the framework's
comparative static ($\partial m^*/\partial \theta_k < 0$):
where oversight is weakest, the FL--price association is largest.
The gradient is monotonic across all four quartiles, suggestive
though not uniquely diagnostic.%
