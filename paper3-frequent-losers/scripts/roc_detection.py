...
OUT_TAB  = V12_DIR / "tables"
OUT_IMG  = V12_DIR / "images"
FLAG_DIR = V12_DIR
...
fp["firm_id"] = fp["firm_id"].astype(str).str.strip().str.zfill(14)
...
cade["firm_id"] = cade["firm_id"].astype(str).str.strip().str.zfill(14)
