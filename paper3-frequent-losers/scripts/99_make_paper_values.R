...
audit_extras <- c(
  ...
  "\\newcommand{\\valShamQ95}{0.521}",
  "\\newcommand{\\valShamQ99}{0.531}",
  ...
  "\\newcommand{\\valClfFifteenPost2019FL}{0.786}",
  "\\newcommand{\\valClfFifteenPost2019TC}{0.854}",
  "\\newcommand{\\valClfSeventeenPost2019FL}{0.844}",
  "\\newcommand{\\valClfSeventeenPost2019TC}{0.894}",
