...
closure motive from documentary sources with an automated language-model
pass. That classification organizes robustness sub-samples in the
replication notes, but it is not validated against human coding and
agreement across models is limited, so it does no identifying work.
...
\input{tables/table_sample_architecture_compact.tex}
