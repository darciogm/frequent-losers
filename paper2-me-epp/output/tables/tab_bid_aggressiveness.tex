...
\midrule
$g65 \times Pre$ & -0.1309*** & -0.1395*** & -0.1227*** & -0.1077*** & -0.1509*** & -0.1223*** \\
 & (0.0096) & (0.0099) & (0.0101) & (0.0138) & (0.0153) & (0.0191) \\
\midrule
...
holding the extensive margin constant. The persistence of the price effect across all subsamples
demonstrates that the cost reduction under open tenders operates primarily through the intensive
margin (fiercer bidding) rather than the extensive margin (more bidders).
