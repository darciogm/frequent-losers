...
A positive coefficient means the winning bid sits further below the
reference price (deeper discount) under open tenders. Under firm FE, the
same bidder submits a lower-priced offer when the SME restriction does
not bind: a direct test of within-bidder behavioral change.
