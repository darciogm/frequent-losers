...
lines <- c(
  ...
  "negative coefficient on log prices (not observed here: estimate is $+0.017$",
  ...
  "coefficient $\\times$ mean exposure is $+0.0005$ log-points---less than half a",
  "percent of the headline $\\hat\\beta = -0.133$. Bias-corrected estimate: $-0.133$.",
