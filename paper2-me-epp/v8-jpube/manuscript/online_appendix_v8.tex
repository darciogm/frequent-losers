...
The structural sample restricts attention to Preg\~ao auctions with at
least \filterMinBidders{} bidders and normalized bids
...
auction data. The main sample contains \nPreAuctions{}
...
$\log p^{\mathrm{final}}$. A McCrary density test at the R\$\,\setAsideThreshBRL{}
