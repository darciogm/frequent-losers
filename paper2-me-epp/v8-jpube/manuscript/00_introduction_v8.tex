...
partial, expensive, and outperformed by a price preference in standardized
markets. The contribution
...
firms submit successively lower offers until one remains. Under the maintained
independent-private-values clock interpretation, losing bidders' drop-out
prices reveal willingness to supply, which I interpret as costs in the
structural model \citep{haile2003}. That is the identifying advantage of the
...
distributions under the maintained model, correct for auction-level scale
