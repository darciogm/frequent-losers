...
# cost while delivering an SME win-rate gain compareble to the full
# set-aside.
...
# Simulate one auction under a price preference at rate k in [0,1).
...
tex <- c(tex,
  ...
  "\\items Bayes-Nash equilibrium simulation, $B = 3{,}000$ MC draws per cell.",
  ...
  "delivers compareble SME win-rate gains to the full set-aside at",
