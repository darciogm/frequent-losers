...
\begin{enumerate}
\item \textbf{Thickness gradient for classical screens.} In thin markets, classical AUCs should be near or below chance. In thick markets, they should recover. This prediction is independent of the temporal-conditioning critique and uses contemporaneous bid data.
