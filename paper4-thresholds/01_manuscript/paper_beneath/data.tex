...
\scriptsize{\textbf{Notes:} ``Firms'' counts unique 8-digit CNPJ roots per cartel; ``In BEC'' counts those matched to BEC bidding records. Total is after deduplication across cartels. Conduct periods are hand-curated from CADE Tribunal decisions and press releases (see Appendix for full audit). Source: script 12.\par}
\end{minipage}
\end{table}
