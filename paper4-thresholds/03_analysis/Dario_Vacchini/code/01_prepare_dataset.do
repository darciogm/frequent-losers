...
* 3. Generate Incumbancy variables
* 4. Generate Backlog variables
* 5. Generate running variable
* 6. Merge with firms data
* 7 . Generate winning streak
* 8. Merge with firms data
* 9. Keep only first and second bids (winner and looser)
* 10. Drop problematic auctions and bids
* 11. Label Variables
...
*** 0. Import data
use if descriçãoprocedimentocompra=="CONVITE" using "/Users/dvacchini/Library/CloudStorage/Dropbox/Projects_Brazilian_data/Data/LANCES_Final_Semester.dta", clear
...
*** 4. Generate Incumbancy variables
...
* Dummy: 1 if firm won an auction at t-1 from same item_group
...
merge m:1 códigofornecedor using "/Users/dvacchini/Library/CloudStorage/Dropbox/Projects_Brazilian_data/Data/Firms_final.dta", keepusing(fornec_latitude fornec_longitude data_inicio_atividade)
...
* Save intermediate
save "$data/intermediate/df_convite_inter.dta"
...
label variable datetimevar "Time of the offer (YMD hms)"
label variable auction_item "Item of the auction"
label variable auction_num "Item ID"
label variable datevar "Date (MY)"
label variable flagvencedor "Dummy: 1 if firm win the auction"
label variable cumsum_win "* Total number of auctions a firm won up until that point"
label variable cumsum_part "Total number of auctions in which a firm partecipated up until that point"
label variable cumsum_win_t_minus_1 "Total number of auctions a firm won up until that point (t-1)"
label variable ratio_won "Ratio won/participated"
label variable ratio_won_t_minus_1 "Ratio won/participated (t-1)"
label variable year "Year"
label variable prop_delta_bid "Difference in bids"


**********************************************************************************

* Save dataset
save "$data/final/df_convite_winner_looser.dta", replace
