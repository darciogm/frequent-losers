...
file open myfile_4 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_90_share_won_market.csv", write replace
...
foreach market in `market_items' {
    ...
    if `n' >= 30 {
        ...
        * Optionally, save regression results in Excel as before
        outreg2 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_90_share_won_market.xls" , excel tex(frag) bdec(4) label ctitle(90_share_won_market_`market') addtext(Year FE, YES)
    }
    else {
