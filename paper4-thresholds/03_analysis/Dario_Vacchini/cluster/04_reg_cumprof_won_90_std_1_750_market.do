...
file open myfile_1 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_cumprof_won_90_std_1_750_market.csv", write replace
    ...
    * Stop the loop after 2500 markets
    ...
    if `n' >= 20 {
        ...
        * Optionally, save regression results in Excel as before
        outreg2 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_cumprof_won_90_std_1_750_market.xls" , excel tex(frag) bdec(4) label ctitle(cumprof_won_90_std_`market') addtext(Year FE, YES)
    }
    else {
