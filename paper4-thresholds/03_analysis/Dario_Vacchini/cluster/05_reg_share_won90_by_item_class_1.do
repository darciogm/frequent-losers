...
file open myfile_1 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_share_won90_by_item_class_1.csv", write replace
    ...
    * Stop the loop after 750 markets
    ...
    if `n' >= 20 {
        ...
        * Optionally, save regression results in Excel as before
        outreg2 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_share_won90_by_item_class_1.xls" , excel tex(frag) bdec(4) label ctitle(share_won90_item_class_`item_class') addtext(Year FE, YES)
    }
    else {
