...
outreg2 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/rd_regression_half.xls", excel tex(frag) bdec(4) label ctitle(Backlog 90 days)
*/

* RD plot of backlog 90 days
rdplot cumprof_won_30_std prop_delta_bid if inrange(prop_delta_bid, -0.5, 0.5) & cumsum_part>10, graph_options(legend(off))

* Save Plot
graph export "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/graphs/rd_plot_backlog_30_days_half.pdf", replace
