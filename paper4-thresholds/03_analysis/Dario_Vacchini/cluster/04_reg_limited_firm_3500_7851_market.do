...
file open myfile_4 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_limited_firm_3500_7581_market.csv", write replace
    ...
    * Stop the loop after 7500 markets
    ...
    if `n' >= 30 {
        ...
        * Optionally, save regression results in Excel as before
        outreg2 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_limited_firm_3500_7581_market.xls" , excel tex(frag) bdec(4) label ctitle(last_bid_`market') addtext(Year FE, YES)
    }
    else {
