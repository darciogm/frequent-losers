...
file open myfile_3 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_share_won90_1500_3500_market.csv", write replace
    ...
    * Stop the loop after 4000 markets
    ...
    if `n' >= 30 {
        ...
        * Optionally, save regression results in Excel as before
        outreg2 using "/cluster/work/lawecon/Projects/procurement_brazil/dario_vacchini/output/tables/reg_share_won90_1500_3500_market.xls" , excel tex(frag) bdec(4) label ctitle(share_won90_`market') addtext(Year FE, YES)
    }
    else {
