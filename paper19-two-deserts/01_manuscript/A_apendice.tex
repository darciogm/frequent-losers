...
distância ($r=0{,}49$ com a distância ao hospital mais próximo) e correlaciona-se
fracamente com F1 ($r=0{,}24$): o embedding recupera isolamento geográfico, não
burden de fluxo. F3 é quase ortogonal a F1 ($r=0{,}20$ para dependência de hub;
$r=-0{,}24$ para o HHI, que confunde autossuficiência local com dependência de
...
\begin{table}[t]
\centering
\caption{Correlação entre as medidas de deserto ($N=5.492$ municípios)}
\label{tab:corr}
\small
...
os dois mapas \emph{discordam} fica entre 57\% e 70\% em todas as regras. O
quadrante perto-mas-isolado --- o ponto cego de uma política de distância --- é
sempre substancial; sob o corte absoluto de 60~km para fluxo, chega a 1.153
municípios. Nenhuma conclusão do corpo depende de um único limiar.
