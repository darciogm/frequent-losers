...
clear all
import delimited "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/ITENS/COMPLETA 27.09.2019.csv", encoding(utf8) stringcols(6 8 10 13 12 15 17)
gen po_item_number_firm = numerodaoc + códigoitem + númerosequênciaitem + códigofornecedor
gen key1_merge = po + códigoitem
sort key1_merge
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/Collapse_2.dta", replace
clear all



use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/Collapse_2.dta", clear
merge m:1 key1_merge using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/Collapse_1_Final.dta"
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/BEC.dta", replace
...
* UCs info
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/BEC.dta", clear
sort pbu_code_year
merge m:1 pbu_code_year using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/UCs_CLEAN_code.dta"
ren _merge _merge_ucs
drop if po == ""

drop if _merge_ucs == 1

append using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/Not Matched_UCs_FINAL.dta"
drop _merge_ucs
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/BEC_UCs.dta", replace



* Firm Info

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/UPDATE_JUL19/BEC_5.dta", clear 
...
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2019.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2018_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2018.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2017_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2017.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2016_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2016.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2015_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2015.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2014_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2014.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2013_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2013.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2012_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2012.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2011_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2011.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2010_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2010.csv", delimiter(";") replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_2009_merge.dta", clear
export delimited using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Dropbox/BEC_2009.csv", delimiter(";") replace
clear all
...
import delimited "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/CSV/LANCES_6.csv", encoding(utf8) stringcols(12 14 16 35 51 59 62 65 69)
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/LANCES_6.dta", replace
clear all

import delimited "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/CSV/LANCES_14.csv", encoding(utf8) stringcols(12 14 16 35 51 59 62 65 69)
drop finalidade diamêsencerramento v32 quantidadedeoc quantidadefornecedorparticipante descriçãostatusfornecedor descriçãotipoempresa descriçãostatusfornecedorbec v48 descriçãofornecedorstatus descriçãobairrofornecedor descriçãoendereçofornecedor descriçãopaísfornecedor descriçãotipoendereçofornecedor diamêsagendamento códdescmunicípiodeentrega códdescregiãodeentrega
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/LANCES_14.dta", replace
clear all

import delimited "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/CSV/LANCES_16.csv", encoding(utf8) stringcols(12 14 16 35 51 59 62 65 69)
drop finalidade diamêsencerramento v32 quantidadedeoc quantidadefornecedorparticipante descriçãostatusfornecedor descriçãotipoempresa descriçãostatusfornecedorbec v48 descriçãofornecedorstatus descriçãobairrofornecedor descriçãoendereçofornecedor descriçãopaísfornecedor descriçãotipoendereçofornecedor diamêsagendamento códdescmunicípiodeentrega códdescregiãodeentrega
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/LANCES_16.dta", replace
clear all

import delimited "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/CSV/LANCES_17.csv", encoding(utf8) stringcols(12 14 16 35 51 59 62 65 69)
drop finalidade diamêsencerramento v32 quantidadedeoc quantidadefornecedorparticipante descriçãostatusfornecedor descriçãotipoempresa descriçãostatusfornecedorbec v48 descriçãofornecedorstatus descriçãobairrofornecedor descriçãoendereçofornecedor descriçãopaísfornecedor descriçãotipoendereçofornecedor diamêsagendamento códdescmunicípiodeentrega códdescregiãodeentrega
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/LANCES_17.dta", replace
clear all



use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/S-CODES_NEW.dta" 
keep categoria grupodocomponente importado padronizadosus princípioativo siafísico
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/S-CODES_NEW_REDUCED.dta"
tab categoria
egen codes_categ=group(categoria)
sort codes_categ
drop if codes_categ==" "
drop in 325648/325649
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/S-CODES_NEW_REDUCED.dta", replace
tab categoria codes_categ
label variable codes_categ "1=Material;2=Medicine Drug;3=Nutrition;4=Other;5=Procedure"
drop categoria
tab grupodocomponente
...
gen cad=1
replace cad=0 if siafísico=="Sem Cadastro"
tab grupodocomponente cad
drop if cad==0
drop if padronizadosus=="Não"
keep if grupodocomponente=="-"
duplicates drop siafísico, force
keep categoria grupodocomponente importado princípioativo siafísico
egen codes_categ=group(categoria)
label variable codes_categ "1=Material;2=Medicine Drug"
drop categoria grupodocomponente
egen codes_import=group(importado)
gen codes_imported=0
replace codes_imported=1 if codes_import==2
drop importado codes_import
label variable codes_imported "1=Imported;0=Not Imported"
ren siafísico codes_siafisico
label variable codes_siafisico "Siafisico Material Code - S-CODES"
ren princípioativo codes_siafisico_descr
label variable codes_siafisico_descr "Siafisico Material Description - S-CODES"
gen item=codes_siafisico
label variable item "Item Code"
sort item

save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/S-CODES_SUBSAMPLE.dta", replace
...
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_FINAL_SOURCE.dta" 


keep if pbu_bureau_code == "09000"
sort item
merge m:1 item using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/S-CODES_SUBSAMPLE.dta", generate(_merge_codes)
...
tabstat bid_qty_log bid_price_ref_log bid_price_log n_firms_prop n_firms_bids n_firms_negot n_firms_pref n_bids_prop n_bids_bids n_bids_negot n_bids_pref , by(jud) statistics(mean semean) save
matrix nT1 = r(Stat1)'
matrix T1 = r(Stat2)'
matrix diff1 = [r(Stat2)-r(Stat1)]'
matrix ptcovstat1 = nT1,T1,diff1
