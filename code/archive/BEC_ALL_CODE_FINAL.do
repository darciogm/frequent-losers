...
* Final product: Collapse_1_ALL.dta
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_ALL_NEW.dta", replace
...
replace year="2018" if _merge_pbu_final==1
replace pbu_code_year= pbu_code + year
sort pbu_code_year
drop _merge_pbu_final
...
drop pubag_code pubag_descr pubbudget_code pubbudget_descr pbu_descr ///
pbu_fedentity_code pbu_fedentity_descr pbu_region_code pbu_region_descr pbu_city_code pbu_city_descr pbu_cnpj pbu_power pbu_type_mgmt_descr _merge_pbu
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_ALL_merge.dta", replace
...
sort firm_zipcode
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Firm_info_ALL.dta", replace
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Firm_info_ALL_merge.dta", replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_ALL_merge.dta", clear
sort firm_id_zipcode
merge m:1 firm_id_zipcode using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Firm_info_ALL_merge.dta"
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Collapse_ALL.dta", replace
clear all
...
sort m_y po item
drop in 3219953/3233597
sort po_item_winner m_y po item
...
sort item
merge m:1 item using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/S-CODES_PRODUCTS_nodupl.dta", generate(_merge_codes)
keep if _merge_codes==3



save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_S-CODES_SUBSAMPLE_ALL.dta", replace

gen jud = 0
replace jud = 1 if strpos(po_subject, "JUDIC") | strpos(po_subject, "LIMINAR") | strpos(po_subject, "MANDADO") | strpos(po_subject, "MAN-DADO") | strpos(po_subject, " AJ") | strpos(po_subject, "(AJ") | strpos(po_subject, "ADMINISTRATIV") | strpos(po_subject, "A.J")
...
replace po_firm_winner = 0 if firm_code == "00Sem Vencedor"


save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Papers/Paper 1 - JUD/BEC_PAPER_1_JUD.dta", replace


drop if po_firm_winner==0
drop if padronizadosus=="Não" 
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Papers/Paper 1 - JUD/BEC_PAPER_1_JUD_winners_and_SUS.dta", replace
...
gen njud_alt=1
replace njud_alt=0 if jud_alt==1


collapse (sum) jud_count=jud_alt njud_count=njud_alt , by(item)
gen sample=0
replace sample=1 if jud_count>0 & njud_count>0
keep if sample==1
sort item
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Papers/Paper 1 - JUD/ITEMS_JUD_AND_NJUD_with_counterfactual.dta", replace
clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/BEC_JUD.dta", clear
sort item
merge m:1 item using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Papers/Paper 1 - JUD/ITEMS_JUD_AND_NJUD_with_counterfactual.dta", generate(_merge_counterf)
keep if _merge_counterf==3
drop ditem*
quietly tabulate item, generate(ditem)
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Papers/Paper 1 - JUD/BEC_PAPER_1_JUD_FINAL_2.dta", replace
replace bid_price=. if bid_price==0
gen bid_price_log=ln(bid_price)
gen bid_price_ref_log=ln(bid_price_ref)
gen bid_qty_log=ln(bid_qty)
drop if categ_item==0
drop if po_status_descr=="FRACASSADO"
drop if po_status_descr=="ENCERRADO SEM VENCEDOR"
drop if po_status_descr=="ENCERRADA"
drop if bid_price==.
psmatch2 jud bid_qty_log ditem*, outcome(bid_price_log) n(5)
psgraph
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/Papers/Paper 1 - JUD/BEC_PAPER_1_JUD_FINAL.dta", replace




collapse (mean) bid_price_working_mean=bid_price bid_price_log_working_mean=bid_price_log bid_qty_working_mean=bid_qty, by(item jud)
