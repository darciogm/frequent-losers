...
drop dataocagendamento dataoccriacao dataocencerramento finalidade descunidadefornecimento datacadastro
...
save BEC_collapse_final.dta, replace																		// Saving new dta
clear all
...
use BEC_collapse_final.dta, clear 																			// Database used
sort po_item_id
save BEC_collapse_final.dta, replace

use BEC_3.dta, clear 																			// Database used
sort po_item_id

merge m:1 po_item_id using BEC_collapse_final.dta
ren _merge_collapse
...
save BEC_3.dta, replace																		// Saving new dta
