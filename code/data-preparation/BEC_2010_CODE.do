...
* Final product: Collapse_1_2010.dta

* 1- Appending Files (Yearly)

use LANCES_4.dta, clear
append using LANCES_3.dta

gen str date1 = substr(mêsanoencerramento,1,7)
drop mêsanoencerramento
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP1/BEC_2010.dta", replace
...
ren finalidade object
label variable object "Bid object"
...
drop  dataocagendamento dataoccriacao dataocencerramento datacadastro
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP2/BEC_2010_merge.dta", replace
...
sort firm_zipcode
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP3/Firm_info_2010.dta", replace
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP4/Firm_info_2010_merge.dta", replace
clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP2/BEC_2010_merge.dta", clear
sort firm_id_zipcode
merge m:1 firm_id_zipcode using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP4/Firm_info_2010_merge.dta", generate(flag)
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP5/BEC_2010_merge_DIST.dta", replace
...
by(po)
sort po
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP6/BYPOitems_2010_merge.dta", replace
...
by(po)
sort po
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP6/BYPOgroups_2010_merge.dta", replace
...
by(po)
sort po
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP6/BYPOclasses_2010_merge.dta", replace

restore 

sort po
merge m:1 po using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP6/BYPOitems_2010_merge.dta", generate(flag_items)
merge m:1 po using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP6/BYPOgroups_2010_merge.dta", generate(flag_groups)
merge m:1 po using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP6/BYPOclasses_2010_merge.dta", generate(flag_classes)

save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/STEP7/BEC_2010_merge_BYPO.dta", replace



* 8- By : Info about each po + item

*clear all
*use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/BEC_2010_merge.dta", clear
...
pbu_ibge_cod_uf ibge_cod_cidade_firm pbu_city_area n_items_po n_classes_po n_groups_po)
...
bid_price_pref_semean_new=bid_price_pref_semean, by(po_item_unit m_y year proc	po	po_status_code	po_status	categ_item	group_item	group_item_descr	class_item	class_item_descr	item	item_descr	item_unit	price_reg	green_item	item_type	pbu_code_year	pbu_code	pbu_year	pbu_latit	pbu_longit	pbu_ibge_cod_uf	ibge_cod_cidade_firm	pbu_city_area n_items_po n_classes_po n_groups_po)


gen key1_merge = po + item
sort key1_merge
duplicates drop key1_merge, force
save  "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/BASELINE/Collapse_1_2010.dta", replace
clear all
