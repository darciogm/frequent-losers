...
************ Preparing Collapse_ ITEMS Pregao
...
clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_proc_1_final.dta", clear
...
*** Ranking bids
drop if props_grupo_status==3
drop if valorunitárioproposta==0
bysort numerodaoc códigoitem fase_oc (valorunitárioproposta) : gen rank = _n
by numerodaoc códigoitem fase_oc: egen bids_sum = max(rank)
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_proc_1_final_validbids_ALTERN.dta", replace



* Tirar 2 linhas abaixo

clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_proc_1_final_validbids_ALTERN.dta", clear
...
************ Preparing Collapse_ ITEMS Convite
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_Items_Convite_ALTERN.dta", replace

drop if data_oc==.

save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_Items_Convite_ALTERN2.dta", replace
...
* Deletar as 2 linhas abaixo
clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_proc_2_final.dta", clear
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_proc_2_final_validbids_ALTERN.dta", replace





************ Preparing Collapse_ ITEMS Dispensa
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_Items_Dispensa_ALTERN.dta", replace

drop if data_oc==.

save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_Items_Dispensa_ALTERN2.dta", replace
...
****** Appending Files + Merge Items Database

clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_Items_Pregao.dta", clear
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Pregao.dta", replace


clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_Items_Convite_ALTERN2.dta", clear 
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Convite.dta", replace


clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_Items_Dispensa_ALTERN2.dta", clear
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Dispensa.dta", replace
...
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Convite.dta", clear

append using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Pregao.dta" "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Dispensa.dta"


save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Appended_Teste.dta", replace
...
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Appended_Teste.dta", clear
...
replace  ano_oc= ano_oc_xxx if _merge_xxx==2
drop ano_oc_xxx

destring  valorunitárionegociado_xxx, replace dpcomma
replace preco_final=valorunitárionegociado_xxx if _merge_xxx==2
drop valorunitárionegociado_xxx

destring qtdeofertacompraitem_xxx, replace dpcomma
replace qtde=qtdeofertacompraitem_xxx if _merge_xxx==2
drop qtdeofertacompraitem_xxx

egen proc=group(proc__xxx)
replace proc_compra=proc if _merge_xxx==2
drop proc__xxx
drop proc

destring  preco_ref_xxx, replace dpcomma
replace preco_ref=preco_ref_xxx if _merge_xxx==2
drop  preco_ref_xxx

egen part=group(partexclmeeppcooper_xxx) 
replace  me_epp=part if _merge_xxx==2
replace me_epp=me_epp-1 if _merge_xxx==2
drop partexclmeeppcooper_xxx part

drop  oc_item_success
ren  oc_item_status_xxx  oc_item_status

replace numerodaoc=numerodaoc_xxx if _merge_xxx==2
drop numerodaoc_xxx

replace mês_oc=mês_oc_xxx if _merge_xxx==2
drop mês_oc_xxx

ren descunidadefornecimento_xxx descunidadefornecimento

ren descrofertacomprastatus_xxx descrofertacomprastatus

replace descriçãoórgão=descriçãoórgão_xxx if _merge_xxx==2
drop descriçãoórgão_xxx

replace descriçãouo=descriçãouo_xxx if _merge_xxx==2
drop descriçãouo_xxx

replace descriçãounidadecompradora=descriçãounidadecompradora_xxx if _merge_xxx==2
drop descriçãounidadecompradora_xxx

replace descitem=descitem_xxx if _merge_xxx==2
drop descitem_xxx

replace descgrupoitem=descgrupoitem_xxx if _merge_xxx==2
drop descgrupoitem_xxx

replace descclasseitem=descclasseitem_xxx if _merge_xxx==2
drop descclasseitem_xxx

replace data_oc=data_oc_xxx if _merge_xxx==2
drop data_oc_xxx

replace códigoórgão=códigoórgão_xxx if _merge_xxx==2
drop códigoórgão_xxx

replace códigouo=códigouo_xxx if _merge_xxx==2
drop códigouo_xxx

replace códigounidadecompradora=códigounidadecompradora_xxx if _merge_xxx==2
drop códigounidadecompradora_xxx

replace códigoitem=códigoitem_xxx if _merge_xxx==2
drop códigoitem_xxx

replace códigogrupo=códigogrupo_xxx if _merge_xxx==2
drop códigogrupo_xxx

ren códigofornecedor_xxx códigofornecedor

replace códigoclasse=códigoclasse_xxx if _merge_xxx==2
drop códigoclasse_xxx
...
merge m:1 numerodaoc códigoitem using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Item Ref/Itens_ref_antiga.dta", keepusing(categ_item2 green_item2) generate(_merge_t1)
drop if _merge_t1==2
...
replace price_reg2=0 if  proc_compra==1 |  proc_compra==2
replace price_reg2=0 if  proc_compra==3 & _merge_price_reg==1

rename price_reg2 reg_precos_ind
drop price_reg1 
...
merge m:1 numerodaoc códigoitem using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Item Ref/Itens_ref_antiga.dta", keepusing(bid_qty_item) generate(_merge_price_qty)
...
drop  jud_adm2 jud  sum_jud jud_regex


save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_FINAIS/BEC_sem_cnae.dta", replace



****************** Forncecs Info (cnae etc.)
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_3.dta", replace
...
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/Final_Semester_proc_2_final_validbids_ALTERN.dta", clear
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_2.dta", replace
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_1.dta", replace



********* Appending Fornecs Info


clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_1.dta", clear

append using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_2.dta" "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_3.dta"

drop if códigoitem==""

sort códigofornecedor

save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_BEC.dta", replace

keep códigofornecedor
duplicates drop
merge 1:1 códigofornecedor using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/CNPJ Geoc/Cnpj_data_inicio_atividade.dta"
drop if _merge==2
drop _merge
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_Info_cnae.dta", replace


clear all

use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_BEC.dta", clear

sort numerodaoc códigoitem códigofornecedor

merge m:1 códigofornecedor using "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_Info_cnae.dta"



save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_Finais/Fornecs_BEC_Completo.dta", replace


****************** Finalizando BEC Completa

clear all
use "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_FINAIS/BEC_sem_cnae.dta", clear
...
drop flagvencedor
drop  winner_bid_oc
drop _merge _merge_fornecs_aux
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_FINAIS/FINAL_FILES/BEC_ITEMS_FINAL.dta", replace




************* Separating files per proc
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/DTA_FINAIS/FINAL_FILES/BEC_ITEMS_FINAL_Convite.dta", replace
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/FINAL_FILES/BEC_ITEMS_FINAL_Dispensa.dta", replace
...
save "/home/darciogm1/projetos/bitter-pills/data/raw/bec-procurement/FINAL/UPDATED/Final_Semester_2020/FINAL_FILES/BEC_ITEMS_FINAL_Pregao.dta", replace
