...
ggsave(file.path(OUT, "fig_within_firm_forest_v10.png"), p1, width = 7.6, height = 4.9, dpi = 150, bg = "white")
...
p2 <- ggplot(uo, aes(coef, label)) +
  ...
  base_theme
ggsave(file.path(OUT, "fig_urgent_coefplot_v10.png"), p2, width = 7.6, height = 3.9, dpi = 150, bg = "white")
...
p3 <- ggplot() +
  ...
  base_theme
ggsave(file.path(OUT, "fig_lee_bounds_interval_v10.png"), p3, width = 7.6, height = 3.3, dpi = 150, bg = "white")
...
ggsave(file.path(OUT, "fig_winner_churn_v10.png"), p4, width = 6.4, height = 4.0, dpi = 150, bg = "white")

cat("Wrote 4 site figures to", OUT, "\n"); print(list.files(OUT, pattern = "_v10\\.png$"))
