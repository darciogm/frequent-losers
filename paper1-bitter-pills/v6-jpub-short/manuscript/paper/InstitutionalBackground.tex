...
The result: 96,000 health court orders nationally in 2017, a 913\% increase in S\~ao Paulo since 2008 (Online Appendix, Figure~A.1). Litigated health spending alone amounts to approximately US\$300~million annually---nearly 5\% of S\~ao Paulo's public health budget.

\subsection{Public Procurement under Judicial Pressure}
\label{sec:procurement_pressure}

The S\~ao Paulo State Department of Health (SES/SP) manages health policy through 99 decentralized public buyer units (PBUs) distributed across the state (Online Appendix, Figure~A.2).
