...
The per capita rates shown in Figure~\ref{fig:distribution} reveal substantial geographic variation, but do not convey the absolute scale of judicial demand. Figure~\ref{fig:litigation_total} complements this view by mapping the total number of litigated cases per municipality. The concentration of cases in large urban centers---particularly the S\~ao Paulo metropolitan area---underscores that the fiscal burden of health litigation falls disproportionately on a small number of municipalities that concentrate both population and judicial activity.
...
This institutional distinction provides a natural comparison group for isolating the ``under the gun'' effect---the additional procurement cost attributable to the threat of judicial sanctions---since administrative and litigated purchases share all planning and execution constraints but differ only in the penalty regime. Figure~\ref{fig:purchase_types} illustrates the three purchase types and their key distinguishing features. Appendix~\ref{sec:appendix_admin} presents complementary geographic evidence on the distribution of administrative demand across municipalities.
