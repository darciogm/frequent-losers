...
The Appendix presents complementary geographic evidence on the spatial distribution of administrative demand (Appendix~\ref{sec:appendix_admin}), which mirrors the patterns documented for litigation in Section~\ref{sec:institutional}.
