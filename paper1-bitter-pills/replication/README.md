...
- **17 publication-ready LaTeX tables** (output/tables/)
- **18 publication-ready PDF figures** (output/figures/)
- **Compiled manuscript PDF** (manuscript/Bitter-Pills_v6.pdf)
...
cd manuscript/
pdflatex -interaction=nonstopmode -jobname=Bitter-Pills_v6 main.tex
