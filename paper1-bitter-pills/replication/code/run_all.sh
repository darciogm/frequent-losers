#!/usr/bin/env bash
# Replicates all tables, figures, and the manuscript PDF.
# Runtime ~10-15 min on a 16-core machine with 16GB RAM.
#
# Usage:
#   cd replication/
