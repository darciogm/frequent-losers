...
* Keep only urgent purchases (admin + litigated)
...
file open tex using "`texdir'/table_balance.tex", write replace
...
di ""
di "  LaTeX table saved to: v3/manuscript/table_balance.tex"
