...
unit. We frame this design as a within-item estimate of the cost margin
associated with the urgent regime, conditional on the institutional
features above.
...
reference price (\BPutgProbitRefPriceCoef, \BPutgProbitRefPricePval)
and SUS-formulary status (\BPutgProbitSUSCoef,
\BPutgProbitSUSPval): admin systematically over-represents items that
...
provide is a bounded decomposition of where the cost
