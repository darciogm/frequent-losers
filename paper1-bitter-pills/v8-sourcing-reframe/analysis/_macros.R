# v8-pointed copy of v7's macro-emit helper. The only difference is BP_VALUES
# resolves to v8-sourcing-reframe/manuscript/paper/values.tex.
...
cat("v8 _macros.R loaded. BP_VALUES =", BP_VALUES, "\n")
