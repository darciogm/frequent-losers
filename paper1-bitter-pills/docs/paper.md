...
The deep-market no-broad-markup result is the central finding. The heterogeneity is more nuanced than a simple thin-market premium: the quantity dimension reflects scale rather than same-firm pricing, while a residual within-firm gap persists in the earlier period — and that surviving gap is administrative-dearer, so it is reported as a bounded non-null rather than litigated-buyer leverage.
